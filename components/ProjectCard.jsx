    ...
    <div>
      <Card className='group overflow-hidden relative'>
        <CardHeader className="p-0">
          <div className='relative w-full h-[260px] flex items-center justify-center bg-tertiary dark:bg-secondary/40 xl:bg-work/project-bg-light xl:dark:bg-work_project_bg_dark xl:bg-[110%] xl:bg-no-repeat overflow-hidden'>
        ...
        <div className='h-full px-8 py-6'>
          ...
          <p className='text-muted-foreground text-lg'>{project.Description}</p> {/* Corrected spelling here */}
        </div>
      </Card>
    </div>
  )
