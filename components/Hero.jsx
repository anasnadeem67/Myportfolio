      ...
      bg-bottom bg-cover dark:bg-none'>
        ...
        <div className='flex justify-between gap-x-8'>
          ...
          <div className='flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left'>
            ...
            <h1 className='h1 mb-4'>Hello, my name is Anas Nadeem</h1>
            <p className='subtitle max-w-[490px] mx-auto xl:mx-0'>
            I am a certified software engineer and a student of blockchain and generative AI.
            </p>
            {/* buttons */}
            <div className='flex flex-col gap-v-3 md:flex-row gap-x-3 mx-auto xl:mx-0 mb-12'>
                <Link href='/contact'>
               ...
               Contact me <Send size={18} />
                ...
                <a href="https://drive.google.com/uc?export=download&id=1a63wMp6KfFZrjUa2opiLqyV5nYU-5fmf" download="Anas_CV.pdf">
